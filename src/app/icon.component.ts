...
export type IconName = 'pencil' | 'square' | 'circle' | 'arrow' | 'eraser' | 'undo' | 'trash' | 'github';
...
@Component({
  ...
  template: `<svg viewBox="0 0 24 24" aria-hidden="true">
    <ng-container [ngSwitch]="name">
      ...
      <rect *ngSwitchCase="'square'" x="4" y="4" width="16" height="16" rx="2"/><circle *ngSwitchCase="'circle'" cx="12" cy="12" r="8"/><path *ngSwitchCase="'arrow'" d="M5 19 19 5M9 5h10v10"/>
    </ng-container>
  </svg>`,
